...
class Index extends Component
{
    ...
    public function mount()
    {
        ...
        $this->count_order_review_year      = Invoice::where('status', 'payment_review')->whereYear('created_at', '=', $year)->get()->count();
         ...
         * total revenue
         */
        $this->total_revenue_month  = Invoice::where('status', 'done')->whereMonth('created_at', '=', $month)->whereYear('created_at', '=', $year)->sum('grand_total');
