                                ...
                                <div class="col-md-6">
                                    <div class="form-group" wire:ignore>
                                        ...
                                        <select class="form-control select-bank-to" wire:model="bank_transfer_to" name="bank_transfer_to" required>
                                            <option value="">-- pilih BANK --</option>
                                            <option value="BCA - 1131458971 - AN. KODIR ZAELANI"> BCA - 1131458971 |
                                                AN. KODIR ZAELANI</option>
                                            <option value="MANDIRI SYARI'AH - 7130309725 - AN. KODIR ZAELANI">
                                                MANDIRI SYARI'AH - 7130309725 | AN. KODIR ZAELANI</option>
                                            <option value="JENIUS / BTPN - 90011961874 - AN. KODIR ZAELANI"> JENIUS /
                                                BTPN - 90011961874 | AN. KODIR ZAELANI</option>
                                        </select>
